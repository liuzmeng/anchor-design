<template>
  <div :class="['page-anchor-tabs']">
    <h3>anchor-radio</h3>
    <div :class="['web-intro']">单选框</div>
    <anchor-row>
      <anchor-col>
        <anchor-row>
          <h5>横向排列模式</h5>
          <div class="web-wrapper">
            <anchor-radio :data="data1" />
          </div>
        </anchor-row>
        <anchor-row>
          <h5>不同默认状态的复选列表</h5>
          <div class="web-wrapper">
            <anchor-radio :data="data2" />
          </div>
        </anchor-row>
      </anchor-col>
      <anchor-col>
        <anchor-row>
          <anchor-col>
            <h5>纵向排列模式</h5>
            <div class="web-wrapper">
              <anchor-radio mode="vertical" :data="data3" />
            </div>
          </anchor-col>
          <anchor-col>
            <h5>不同默认状态的复选列表</h5>
            <div class="web-wrapper">
              <anchor-radio mode="vertical" :data="data4" />
            </div>
          </anchor-col>
        </anchor-row>
      </anchor-col>
    ...
    data () {
      return {
        ...
        listData:[
          ...
          {param: 'mode', type: 'string', desc: '菜单布局，分为水平和垂直两种', default: 'horizontal', range: 'horizontal / vertical', necessary: '否', remark: ''},
